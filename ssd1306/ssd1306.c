...
char ssd1306_WriteChar(char ch, FontDef Font)
{
	...
	if (width() <= (SSD1306.CurrentX + Font.FontWidth) || height() <= (SSD1306.CurrentY + Font.FontHeight))
	{
...
#else
	HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40, 1, data, size, 50);
#endif
}
